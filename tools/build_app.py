...
#
# 取 30 天是**用户 2026-09-22 的定稿**，不是调研结论。调研给的是 45 天：日经 2026-09-21
# 实测中美 9 家头部厂商「高性能模型」的平均更新间隔已从 2023-01~2026-03 的 125 天
# 缩短到 2026-04~09 的 44 天，按「一个发布代际」该取 45。
# **明知代价取 30**：本库实测各家自己的相邻发布间隔中位 Alibaba 19 / Meta 21 / Google 30 /
# OpenAI 34 / Anthropic 42 / Zhipu 50 / Mistral 52 / DeepSeek 63 / xAI 71 天 ——
# 30 天会漏掉 >30 的那几家旗舰（45 天亮 13 行，30 天只亮 8 行）。换来的是标识更「新」。
# 想临时放宽/收紧都不必重建数据：URL 上带 ?new=45 / ?new=14 即可。
NEW_WINDOW_DAYS = 30
